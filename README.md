...
7) Current density metrics: the script calculates median and max current density values for each subject, for each dataset, for the three ROIs left M1, left thalamus and right cerebellum. 
