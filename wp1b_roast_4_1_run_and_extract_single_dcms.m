%% This script runs a PEB of pre < post within subject, for the wp1b dataset

% loading GCM struct with 126 DCMs (sham pre sham post, cath pre cath post,
% anod pre anod post x participant)
load('wp1b_DCMfiles/GCM_fullAB_all.mat')
